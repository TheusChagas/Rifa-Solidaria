                        ...
                        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold px-4 text-slate-800 drop-shadow-lg leading-tight mb-6">
                            ...
                            <span className="relative inline-block">
                                <CarrosselVertical
                                    ...
                                    interval={2000}
                                    className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-green-600 font-bold"
                                />
                                    ...
                                    <div className="flex animate-scroll-left">
                                        ...
                                        <div className="flex space-x-6 flex-shrink-0">
                                            {apoiadores.map((apoiador, index) => (
                                                <div 
                                                    key={index}
                                                    className="group relative flex-shrink-0 w-[200px] sm:w-[220px] md:w-[240px]"
                                                >
                                                    {/* Glow effect */}
