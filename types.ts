...
export const jogoDoBicho: Animal[] = [
    ...
    { id: 10, nome: "Coelho", numeros: [37, 38, 39, 40], icone: require("@/assets/coelho.png").default },
    { id: 11, nome: "Cavalo", numeros: [41, 42, 43, 44], icone: require("@/assets/cavalo.png").default },
    { id: 12, nome: "Elefante", numeros: [45, 46, 47, 48], icone: require("@/assets/elefante.png").default },
    { id: 13, nome: "Galo", numeros: [49, 50, 51, 52], icone: require("@/assets/galo.png").default },
    { id: 14, nome: "Gato", numeros: [53, 54, 55, 56], icone: require("@/assets/gato.png").default },
    { id: 15, nome: "Jacaré", numeros: [57, 58, 59, 60], icone: require("@/assets/jacare.png").default },
    { id: 16, nome: "Leão", numeros: [61, 62, 63, 64], icone: require("@/assets/leao.png").default },
    { id: 17, nome: "Macaco", numeros: [65, 66, 67, 68], icone: require("@/assets/macaco.png").default },
    { id: 18, nome: "Porco", numeros: [69, 70, 71, 72], icone: require("@/assets/porco.png").default },
    { id: 19, nome: "Pavão", numeros: [73, 74, 75, 76], icone: require("@/assets/pavao.png").default },
    { id: 20, nome: "Peru", numeros: [77, 78, 79, 80], icone: require("@/assets/peru.png").default },
    { id: 21, nome: "Touro", numeros: [81, 82, 83, 84], icone: require("@/assets/touro.png").default },
    { id: 22, nome: "Tigre", numeros: [85, 86, 87, 88], icone: require("@/assets/tigre.png").default },
    { id: 23, nome: "Urso", numeros: [89, 90, 91, 92], icone: require("@/assets/urso.png").default },
    { id: 24, nome: "Veado", numeros: [93, 94, 95, 96], icone: require("@/assets/veado.png").default },
    { id: 25, nome: "Vaca", numeros: [97, 98, 99, 0], icone: require("@/assets/vaca.png").default },
];
